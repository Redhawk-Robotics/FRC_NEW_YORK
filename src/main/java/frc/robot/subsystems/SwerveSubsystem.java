...
import frc.robot.modules.PigeonModule;
...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem() {
    ...
    swerveOdometry = new SwerveDriveOdometry(Settings.mKinematics, getYaw(), getPositions());

    // Creating the position estimation of the SwerveDrive
    poseEstimator = new SwerveDrivePoseEstimator(Settings.mKinematics, getYaw(),
  ...
  public void drive(
    ...
    SwerveModuleState[] swerveModuleStates = Settings.mKinematics.toSwerveModuleStates(
        fieldRelative
            ? ChassisSpeeds.fromFieldRelativeSpeeds(
                translation.getX(), translation.getY(), rotation, getYaw())
            : new ChassisSpeeds(translation.getX(), translation.getY(), rotation));
    SwerveDriveKinematics.desaturateWheelSpeeds(swerveModuleStates,
        Settings.maxVelocityMetersPerSecond);
  ...
  public void setModuleStates(SwerveModuleState[] desiredStates) {
    SwerveDriveKinematics.desaturateWheelSpeeds(desiredStates, Settings.maxVelocityMetersPerSecond);
