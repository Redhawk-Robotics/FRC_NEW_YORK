...
public interface Ports {
    ...
    public static final class Extender {
        ...
        public static final boolean ExtenderMotorInvert = true;
    }
    ...
    public static final class Claw {
        ...
        public static final class clawPneumatic {
            public static final int clawForwardChannel = 1;// FIXME
            public static final int clawReverseChannel = 0;// FIXME
        }
    }
