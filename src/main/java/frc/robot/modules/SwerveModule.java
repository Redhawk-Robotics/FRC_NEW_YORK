...
//Creating a FeedForward Settings for a reference tracking for the desired output of the motor
SimpleMotorFeedforward feedForward =
new SimpleMotorFeedforward(Settings.driveKS,Settings.driveKV,Settings.driveKA);//FIXME find values
...
private void setAngle(SwerveModuleState desiredState) {
    ...
    Rotation2d angle =
        (Math.abs(desiredState.speedMetersPerSecond) <= (Settings.maxVelocityMetersPerSecond * 0.01))
            ? lastAngle
            : desiredState.angle;
